...
main:
    ...
    movq %rax, %rdx               # Copy `test` into `temp_2`
    movq $8, %rsi                 # Load number '8' into `temp_3`
    movq %rdx, %rcx               # Prepare `temp_1` for addition
    addq %rsi, %rcx               # Add `temp_2` and `temp_3` into `temp_1`
    xchgq %rsi, %r8               # Swap temp_3 and @swap_temp_1
